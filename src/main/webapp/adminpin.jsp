      ...
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center" data-aos="fade">
            <h1 class="heading mb-3">Verify Admin PIN</h1>
            <ul class="custom-breadcrumbs mb-4">
              <li><a href="index.jsp">Home</a></li>
              <li>&bullet;</li>
              <li>Verify Admin PIN</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7" data-aos="fade-up" data-aos-delay="100">
            <p>Admin PIN Was Given By Resort Managment</p>
            <form action="AdminController" method="post" class="bg-white p-md-5 p-4 mb-5 border">
               <div class="row">
...
%>
				<div class="row"></div>
                  <label for="otp">Enter Admin PIN</label>
                  <input type="password" name="pin"  class="form-control ">
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="submit" value="Verify PIN" name="action" class="btn btn-primary text-white font-weight-bold">
                </div>
              </div>
            </form>
          </div>
