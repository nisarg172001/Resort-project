      ...
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center" data-aos="fade">
            ...
            <h1 class="heading mb-3">Admin Sign Up</h1>
...
%>
            <form action="AdminController" name="adminsignup" method="post" class="bg-white p-md-5 p-4 mb-5 border">
              <div class="row">
              ...
              <div class="row mb-4">
                <div class="col-md-12 form-group">
                  ...
                  <textarea name="address" id="message" class="form-control " cols="30" rows="8"></textarea>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 form-group">
                ...
                <div class="col-md-6 form-group">
                  ...
                  <input type="password" id="name" name="cpassword" class="form-control ">
                </div>
              </div>
              
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="submit" name="action" value="Insert" class="btn btn-primary text-white font-weight-bold">
                </div>
              </div>
            </form>
			<a href="login.jsp"><u>Already Admin?Login Now</u></a>
          </div>
