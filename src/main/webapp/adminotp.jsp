      ...
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center" data-aos="fade">
            <h1 class="heading mb-3">Verify OTP</h1>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7" data-aos="fade-up" data-aos-delay="100">
            <p>OTP Was Sent To Your Registered Email</p>
            <form action="AdminController" method="post" class="bg-white p-md-5 p-4 mb-5 border">
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="submit" value="Verify OTP" name="action" class="btn btn-primary text-white font-weight-bold">
                </div>
              </div>
            </form>
          </div>
