      ...
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center" data-aos="fade">
            ...
            <h1 class="heading mb-3">New Password</h1>
...
%>
            <form action="AdminController" name="newpassword" method="post" class="bg-white p-md-5 p-4 mb-5 border">
              <div class="row">
                <div class="col-md-12 form-group">
                  <input type="hidden" name="email" id="email" value="<%=request.getAttribute("email")%>" class="form-control ">
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-md-6 form-group">
                  ...
                  <input type="password" id="name" name="cnewpassword" class="form-control ">
                </div>
              </div>
              
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="submit" name="action" value="Update Password" class="btn btn-primary text-white font-weight-bold">
                </div>
              </div>
            </form>
			<a href="login.jsp"><u>Already Registered?Login Now</u></a>
          </div>
