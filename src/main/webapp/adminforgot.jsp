      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7" data-aos="fade-up" data-aos-delay="100">
            ...
            <form action="AdminController" method="post" name="forgotpassword" class="bg-white p-md-5 p-4 mb-5 border">
              <div class="row">
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="submit" name="action" value="Send OTP" class="btn btn-primary text-white font-weight-bold">
                </div>
              </div>
            </form>
            </div>
