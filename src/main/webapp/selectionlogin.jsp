      ...
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center" data-aos="fade">
            <h1 class="heading mb-3">Select User Type For Login</h1>
            <ul class="custom-breadcrumbs mb-4">
              <li><a href="index.jsp">Home</a></li>
              <li>&bullet;</li>
              <li>Select User Type For Login</li>
            </ul>
          </div>
        </div>
      </div>
            ...
            <form action="UserController" method="post" name="login" class="bg-white p-md-5 p-4 mb-5 border">
              <div class="row">
                <div class="col-md-12 form-group">
                  <a class="btn btn-primary text-white font-weight-bold" href="login.jsp">User</a><strong> OR </strong>
                  <a class="btn btn-primary text-white font-weight-bold" href="adminlogin.jsp">Admin</a>
                </div>
              </div>
              </div>
            </form>
