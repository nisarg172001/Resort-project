...
%>
            ...
            <form action="AdminController" method="post" name="login" class="bg-white p-md-5 p-4 mb-5 border">
              <div class="row">
            ...
            <a href="adminforgot.jsp"><u>Forgot password?</u></a>
            <br>
			<a href="adminsignup.jsp"><u>New Admin?Register Now</u></a>
          </div>
